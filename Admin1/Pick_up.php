            ...
            <div class="container">
                <div class="nav">
					<ul>
						...
						<li><a href="Delete_route.php">Delete Travel</a></li>
            ...
            <div class="row">
                ...
                <div class="register span8">
					...
					<table class= "table-responsive" cellspacing="15" cellpadding="15">
                        <h2>Pick-UP<span class="red" style="color:red; font-size:30px">  Info.</span></h2>
                        <tr><td><label for="travel_id">Travel_ID</label>
                        <input type="text" id="travel_id" name="travel_id" placeholder="enter your travel_id..."></td></tr>
                        <tr><td><label for="pick-up">Pick-up Location</label>
                        <input type="text" id="pick-up" name="pick-up" placeholder="enter pick-up location..."></td>
						</tr>
