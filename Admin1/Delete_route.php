            ...
            <div class="row">
                ...
                <div class="register span8">
					...
					<table class= "table-responsive" cellspacing="15" cellpadding="15">
                         <h2>Delete Travel <span class="red" style="color:red; font-size:30px">ROUTE</span></h2>
                        <tr><td><label for="route_id">Route_ID</label>
                        <input type="text" id="route_id" name="route_id" placeholder="enter your route_id..."></td>
