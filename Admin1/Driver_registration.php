            ...
            <div class="row">
                ...
                <div class="register span8">
					...
					<table class= "table-responsive" cellspacing="15" cellpadding="15">
                       <h2>REGISTER TO<span class="red" style="color:red; font-size:30px">  DRIVER</span></h2>
                        <tr><td><label for="firstname">First Name</label>
                        <input type="text" id="firstname" name="firstname" placeholder="enter your first name..."></td>
